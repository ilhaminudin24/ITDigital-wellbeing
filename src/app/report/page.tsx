            ...
            <div className="w-full max-w-lg flex flex-col flex-grow pb-28">
                ...
                <main className="flex flex-col px-6 gap-6 w-full">
                    ...
                    <div className="flex justify-end">
                        <button className="px-3 py-1.5 rounded-full border border-gray-200 flex items-center gap-1 text-xs font-bold bg-white text-text-muted hover:text-primary hover:border-primary transition-all shadow-sm">
                            2024
                    ...
                    <div className="bg-white border border-gray-200 p-6 shadow-sm rounded-3xl">
                        ...
                        <div className="flex items-end justify-between mb-4">
                            <div className="flex items-baseline">
                                <span className="text-[42px] font-bold text-primary leading-none">85</span>
                                <span className="text-xl text-gray-400 font-semibold ml-1">km</span>
                            </div>
                            <div className="text-right">
                                <p className="text-primary font-bold text-lg">56%</p>
                        ...
                        <div className="h-4 w-full rounded-full bg-gray-100 overflow-hidden">
                            <div className="h-full w-[56%] rounded-full bg-accent relative shadow-[0_0_10px_rgba(255,219,0,0.4)]">
                    ...
                    <div className="bg-white border border-gray-200 p-6 shadow-sm rounded-3xl">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-gray-400 text-sm">Jan - Dec 2024</p>
                            </div>
                        ...
                        <div className="grid min-h-[160px] grid-cols-7 items-end gap-2 sm:gap-3">
                            ...
                            <div className="group flex flex-col items-center gap-2">
                                <div className="w-full rounded-t-lg bg-primary/20 group-hover:bg-primary transition-all duration-300" style={{ height: "40%" }}></div>
                                <span className="text-xs font-bold text-gray-400">J</span>
                            </div>
                            {/* Feb */}
                            <div className="group flex flex-col items-center gap-2">
                                <div className="w-full rounded-t-lg bg-primary/20 group-hover:bg-primary transition-all duration-300" style={{ height: "45%" }}></div>
                                <span className="text-xs font-bold text-gray-400">F</span>
                            </div>
                            {/* Mar (Best) */}
                            <div className="group flex flex-col items-center gap-2">
                                <div className="relative w-full rounded-t-lg bg-accent shadow-sm" style={{ height: "85%" }}></div>
                                <span className="text-xs font-bold text-primary">M</span>
                            </div>
                            {/* Apr */}
                            <div className="group flex flex-col items-center gap-2">
                                <div className="w-full rounded-t-lg bg-primary/20 group-hover:bg-primary transition-all duration-300" style={{ height: "50%" }}></div>
                            ...
                            {/* Jun */}
                            <div className="group flex flex-col items-center gap-2">
                                <div className="w-full rounded-t-lg bg-primary/20 group-hover:bg-primary transition-all duration-300" style={{ height: "65%" }}></div>
                                <span className="text-xs font-bold text-gray-400">J</span>
                            </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col gap-2 rounded-3xl bg-white border border-gray-200 p-5 shadow-sm">
                            ...
                            <div>
                                ...
                                <p className="text-gray-900 text-xl font-bold">12.1 km</p>
                            </div>
                        </div>
                        <div className="flex flex-col gap-2 rounded-3xl bg-white border border-gray-200 p-5 shadow-sm">
                            <div className="mb-1 flex h-10 w-10 items-center justify-center rounded-full bg-gray-50 text-primary">
                            ...
                            <div>
                                ...
                                <p className="text-gray-900 text-xl font-bold">March</p>
                            </div>
                        </div>
                        ...
                        <div className="col-span-2 flex items-center justify-between rounded-3xl bg-white border border-gray-200 p-6 shadow-sm">
                            <div>
                                ...
                                <p className="text-primary text-3xl font-bold">65 km</p>
                            </div>
                            <button className="rounded-full bg-primary/5 px-6 py-3 text-sm font-bold text-primary hover:bg-primary/10 transition-colors">
                                Log Walk
                            </button>
                        </div>
                    </div>
